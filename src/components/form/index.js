  ...
  <Container>
    ...
    >
      ...
      <Card>
        ...
        <Text>
          Здесь изложена какая нибудь дополнительная информация о том насколько
          важен был этот опрос и как его результаты могут быть полезены для
          разработки проекта. И еще какая нибудь информация.
        </Text>
        <Checkbox>
        ...
        <AntdForm.Item>
          <SurveyButton type="primary" htmlType="submit">
            Отправить
          </SurveyButton>
        </AntdForm.Item>
      </Card>
